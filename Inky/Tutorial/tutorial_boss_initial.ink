...
I'm listening.
#name Boss
Detective G.'s Nueralyzer has been stolen.
...
If the tech got duplicated, and fell into the wrong hands, we would be incarcerated in a second.
#name player 
I know the stakes.
#name Boss 
Good.
...
#name player 
Cut to the chase Boss. Memory Wipe to erase their memory. Got it.
#name Boss 
...
Sure, can do.
#name Boss 
Oh, and the floating aquiarium module also records voice audio. So if you catch the interrogee lying, use the respective button to call them out.
#name player 
Wipe their memory, confront them if they contradict themselves. I think I understand.
